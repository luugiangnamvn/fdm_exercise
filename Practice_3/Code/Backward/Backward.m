%% ---PDEs Heate Equations with Backward Method---
...
plot(log(number_mesh_point), -log(error_H0),'blue',...
    ...
    log(number_mesh_point), 1/2*log(number_mesh_point),'yellow');
xlabel('Log(MeshPoint)');ylabel('-Log(Error)');
title('Errors');
legend('norm_{H_0}','norm_{L_2}','2x','x','1/2x','Location','NorthEastOutside');  
